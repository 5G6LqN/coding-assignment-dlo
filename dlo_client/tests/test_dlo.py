...
def test_generate_hmac_token():
    assert DLORequest._generate_hmac_token({"a": "A"},
                                           "12345") == "521125e97ad36e3c45f60946af98e29583512651aeaae2eb6947cfb36037978422256619d040a84d861ad375fa09e8e52f47297dfa6f57d2f9969e0081261fcc"


@freeze_time("2024-09-20T14:05:43Z")
@mock.patch("dlo_client.dlo.DLORequest._generate_nonce")
@pytest.mark.parametrize("usertype, expected_result",
                         [
